...
-- 3.Find the names of the sailor who have not reserved a boat whose name contains the string 
...
-- 7.Create a view that shows the names and colours of all the boats that have been reserved by a 
